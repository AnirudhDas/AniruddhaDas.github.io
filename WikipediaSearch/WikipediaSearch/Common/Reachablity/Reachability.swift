...
public enum CustomReachabilityError: Error {
...
func callback(reachability: SCNetworkReachability, flags: SCNetworkReachabilityFlags, info: UnsafeMutableRawPointer?) {
    ...
    let reachability = Unmanaged<CustomReachability>.fromOpaque(info).takeUnretainedValue()
...
public class CustomReachability {
    ...
    public typealias NetworkReachable = (CustomReachability) -> ()
    public typealias NetworkUnreachable = (CustomReachability) -> ()
...
public extension CustomReachability {
    ...
    func startNotifier() throws {
        ...
        context.info = UnsafeMutableRawPointer(Unmanaged<CustomReachability>.passUnretained(self).toOpaque())
        if !SCNetworkReachabilitySetCallback(reachabilityRef, callback, &context) {
            stopNotifier()
            throw CustomReachabilityError.UnableToSetCallback
        }
        
        if !SCNetworkReachabilitySetDispatchQueue(reachabilityRef, reachabilitySerialQueue) {
            stopNotifier()
            throw CustomReachabilityError.UnableToSetDispatchQueue
        }
...
fileprivate extension CustomReachability {
